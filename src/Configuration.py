...
class Configuration:
    ...
    def processKeyDownEvent(self):
        ...
        # Zoom and unzoom                       
        if self.event.dict['unicode'] == 'UpArrow' or self.event.key == pygame.K_UP:
            gl.glScalef(1.1,1.1,1.1)                   
        elif self.event.dict['unicode'] == 'DownArrow' or self.event.key == pygame.K_DOWN:
    ...
    def processMouseMotionEvent(self):
        if pygame.mouse.get_pressed()[0]==1:
          gl.glTranslatef(self.event.rel[0]*0.04,0,0)
        if pygame.mouse.get_pressed()[0]==1:
          gl.glTranslatef(0,0,-self.event.rel[1]*0.04)
